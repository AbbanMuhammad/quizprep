// =============================================
// QUIZPREP — Authentication Logic (CORRECTED)
// Fixes: Removed duplicate getCurrentUser/setCurrentUser
//        (now defined in app.js which loads on every page),
//        absolute redirect paths
// =============================================
// ─────────────────────────────────────────────
// STORAGE (auth-specific only)
// getCurrentUser() and setCurrentUser() are defined
// in app.js — do NOT redefine them here to avoid
...
function initRegister() {
    ...
    registerBtn.onclick = function () {
        ...
        ["regName", "regEmail", "regPassword", "regConfirm"].forEach(
            clearError
        );
        hideError("registerError");
        if (!name) {
